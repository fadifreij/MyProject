...
import { SliderComponent } from '../../common/slider-component/SliderComponent';
const renderSlideItem = (product) => {
    return (
        <div className="col-lg-4">
            <div className="product__discount__item">
                <div className="product__discount__item__pic set-bg"
                    style={{ backgroundImage: `url(${product.img})`, margin: `10px` }}
                >
                ...
                <div className="product__discount__item__text">
                    ...
                    <h5><a href="#">{product.label}</a></h5>
                    <div className="product__item__price">$30.00 <span>{product.price}</span></div>
                </div>
            </div>
        </div>
    )
                        ...
                        <div className="product__discount">
                            ...
                            <div class="row">
                                <div class="product__discount__slider">
                                    <SliderComponent products={products} renderItem={renderSlideItem} slidesToShow={3} showArrows={false} />
                                </div>
                            </div>
                        </div>
