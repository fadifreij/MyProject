...
dotnet build ./ECommerce.DAL/ECommerce.DAL.csproj
...
# Update database
dotnet ef database update --project ./ECommerce.DAL/ECommerce.DAL.csproj --startup-project ./ECommerce.ApiServices/ECommerce.ApiServices.csproj
